...
if __name__ == '__main__':
    ...
    # create output file
    output = FileWriter(f'./processed/{filename}/processed.csv', ",".join(['epoch','batch_idx','test_acc','unique_ap','mean_ap_sim@10','std_ap_sim@10','mean_ap_sim@100','std_ap_sim@100']))
